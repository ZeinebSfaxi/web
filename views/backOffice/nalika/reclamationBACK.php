                            ...
                            <table>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td> <form method="post" action="http://localhost/projet - Copie/views/backOffice/nalika/traiterR.php">
                                        ...
                                        <
                                        <td> <form method="post" action="http://localhost/projet - Copie/views/backOffice/nalika/deletereclamation.php">
                                                <button data-toggle="tooltip" title="Trash" ><i class="fa fa-trash-o" aria-hidden="true" ></i></button>
