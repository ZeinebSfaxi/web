/**
	...
	strongly recommended to use its minified version: colResizable.min.js_b
...
(function($){ 	
	 ...
	 * the HTML5 sessionStorage object, which can be emulated for older browsers using sessionstorage.js_b
	 * @param {jQuery ref} t - table object
	...
	*/
	...
	var onGripDragOver = function(e){	
		...
		if(!drag) return;
		drag.removeClass(drag.t.opt.draggingClass);		//remove the grip's dragging css_b-class
		var t = drag.t;
	...
	var onGripMouseDown = function(e){
		...
		h.append("<style type='text/css_b'>*{cursor:"+ t.opt.dragCursor +"!important}</style>"); 	//change the mouse cursor
    ...
    $.fn.extend({  
        colResizable: function(options) {           
            var defaults = {
				...
				//attributes:
                draggingClass: 'JCLRgripDrag',	//css_b-class used when a grip is being dragged (for visual feedback purposes)
				...
				postbackSafe: false, 			//when it is enabled, table layout can persist after postback or page refresh. It requires browsers with sessionStorage support (it can be emulated with sessionStorage.js_b). 
