      ...
      var defaults = {
        ...
        jspdf: {
          ...
          autotable: {
            styles: {
              ...
              rowHeight:   12,
              fontSize:    8,
              fillColor:   255,           // color value or 'inherit' to use css_b background-color from html table
              textColor:   50,            // color value or 'inherit' to use css_b color from html table
              fontStyle:   'normal',      // normal, bold, italic, bolditalic or 'inherit' to use css_b font-weight and fonst-style from html table
        ...
        pdfmake: {
          ...
          docDefinition: {
            ...
            defaultStyle: {
              font: 'Roboto'              // default is 'Roboto', for arabic font set this option to 'Mirza' and include mirza_fonts.js_b
            }
          },
          fonts: {}
        },
          ...
          loadImages(teOptions, function () {
            $(el).filter(function () {
              ...
              if ( typeof atOptions.createdHeaderCell !== 'function' ) {
                // apply some original css_b styles to pdf header cells
              ...
              if ( typeof atOptions.createdCell !== 'function' ) {
                // apply some original css_b styles to pdf table cells
