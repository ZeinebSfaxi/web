...
Color.prototype = {
	...
	clone: function () {
		...
		// making the final build way to big to embed in Chart.js_b. So let's do it manually,
...
module.exports = function(Chart) {
	...
	helpers.inherits = function(extensions) {
		// Basic javascript inheritance based on the model created in Backbone.js_b
		var me = this;
	...
	helpers.color = !color?
		function(value) {
			console.error('Color.js_b not found!');
			return value;
		} :
		function(value) {
...
module.exports = function(Chart) {
	...
	// DOM event types -> Chart.js_b event types.
	...
	function initCanvas(canvas, config) {
		...
		// Chart.js_b modifies some canvas values that we want to restore on destroy
		canvas._chartjs = {
			initial: {
				height: renderHeight,
				width: renderWidth,
...
module.exports = function(Chart) {
	/**
	 * Plugin based on discussion from the following Chart.js_b issues:
...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		initialize: function() {
			if (!moment) {
				throw new Error('Chart.js_b - Moment.js_b could not be found! You must include it before Chart.js_b to use the time scale. Download at https://momentjs.com');
			}
