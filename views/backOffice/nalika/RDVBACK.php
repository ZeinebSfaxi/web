        ...
        <nav id="sidebar" class="">
            ...
            <div class="nalika-profile">
                <div class="profile-dtl">
                    ...
                    <h2>Geoconcept- <span class="min-dtn"></span>Geoverde</h2>
                </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Produits" href="index.html"><span class="mini-sub-pro">Produits</span></a></li>
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu">
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="img_b/contact/1.jpg" alt="">
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="img_b/contact/4.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="img_b/contact/3.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="img_b/contact/2.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td> <form method="post" action="http://localhost/projet - Copie/views/backOffice/nalika/accepterRDV.php">
                                            <input type="hidden" value="<?PHP echo $row['ID_RDV']; ?>" name="ID_RDV">
                                        <button class="btn btn-custon-three btn-success">Accepter</button>
                                        </form>
                                    </td>

                                    <td> <form method="post" action="http://localhost/projet - Copie/views/backOffice/nalika/refuserRDV.php">
                                            <input type="hidden" value="<?PHP echo $row['ID_RDV']; ?>" name="ID_RDV">
                                    ...
                                    <td> <form method="post" action="http://localhost/projet - Copie/views/backOffice/nalika/deleteRDV.php">
                                            <button data-toggle="tooltip" title="Trash" ><i class="fa fa-trash-o" aria-hidden="true" ></i></button>
