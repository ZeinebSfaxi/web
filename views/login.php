		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 animate-box">
					<form method="post" action="llog.php">
						<div class="row form-group">
							<div class="col-md-12">
								<label for="lname">Login:</label>
								<input type="text" id="lname" name="lname" class="form-control" placeholder="Log">
							</div>
						</div>
						<div class="row form-group">
							<div class="col-md-12">
						...
						<input type="submit" id ="log" name="log" class="btn btn-primary" value="log-in"/>
					</form>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<h2>Abonnez-vous</h2>
					<p>Abonnez-vous pour ne ratez aucune nouveauté dèz maintenant</p>
				</div>
			</div>
			<div class="row animate-box">
